...
<body>
<h1> picmod Photos </h1>
<p> This web page was generated by the picmod program (available
<a href="https://github.com/alexKleider/picmod">here</a>)
which accepts image files and from them generates an 'index.html' 
file (to which your browser must be currently pointing.)
This file can then be edited as you see fit.</p>
<!--
<h3> OTHER LINKS </h3>
<ul>
